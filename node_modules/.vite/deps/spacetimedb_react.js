...
var _connections, __ConnectionManagerImpl_instances, ensureEntry_fn, notify_fn, _a5;
var ConnectionManagerImpl = (_a5 = class {
  constructor() {
    __privateAdd(this, __ConnectionManagerImpl_instances);
  ...
  getKey(uri, moduleName) {
    return _a5.getKey(uri, moduleName);
  }
  /**
   ...
   */
  retain(key, builder) {
    const managed = __privateMethod(this, __ConnectionManagerImpl_instances, ensureEntry_fn).call(this, key);
    ...
    const updateState = (updates) => {
      ...
      __privateMethod(this, __ConnectionManagerImpl_instances, notify_fn).call(this, managed);
    };
    updateState({
  ...
  release(key) {
    const managed = __privateGet(this, _connections).get(key);
    if (!managed) {
      return;
    }
    managed.refCount -= 1;
    ...
    managed.pendingRelease = setTimeout(() => {
      ...
      __privateGet(this, _connections).delete(key);
    }, 0);
  }
  ...
  getSnapshot(key) {
    var _a6;
    return (_a6 = __privateGet(this, _connections).get(key)) == null ? void 0 : _a6.state;
  }
  getConnection(key) {
    var _a6;
    return ((_a6 = __privateGet(this, _connections).get(key)) == null ? void 0 : _a6.connection) ?? null;
  }
}, _connections = new WeakMap(), __ConnectionManagerImpl_instances = new WeakSet(), ensureEntry_fn = function(key) {
  const existing = __privateGet(this, _connections).get(key);
  if (existing) {
    return existing;
  }
  const managed = {
  ...
  __privateGet(this, _connections).set(key, managed);
  return managed;
}, notify_fn = function(managed) {
  ...
  const subscribe = (0, import_react.useCallback)(
    (onStoreChange) => {
      ...
      const onInsert = (ctx, row) => {
        ...
        (_a7 = callbacks == null ? void 0 : callbacks.onInsert) == null ? void 0 : _a7.call(callbacks, row);
      ...
      const onDelete = (ctx, row) => {
        ...
        (_a7 = callbacks == null ? void 0 : callbacks.onDelete) == null ? void 0 : _a7.call(callbacks, row);
        if (ctx.event.id !== latestTransactionEventId.current) {
          latestTransactionEventId.current = ctx.event.id;
          lastSnapshotRef.current = computeSnapshot();
          onStoreChange();
      ...
      const onUpdate = (ctx, oldRow, newRow) => {
        ...
        switch (change) {
          case "leave":
            (_a7 = callbacks == null ? void 0 : callbacks.onDelete) == null ? void 0 : _a7.call(callbacks, oldRow);
            break;
          case "enter":
            (_b = callbacks == null ? void 0 : callbacks.onInsert) == null ? void 0 : _b.call(callbacks, newRow);
            break;
          case "stayIn":
            (_c = callbacks == null ? void 0 : callbacks.onUpdate) == null ? void 0 : _c.call(callbacks, oldRow, newRow);
            break;
          case "stayOut":
            return;
        }
      ...
      (_a6 = table.onUpdate) == null ? void 0 : _a6.call(table, onUpdate);
      return () => {
        var _a7;
        table.removeOnInsert(onInsert);
        table.removeOnDelete(onDelete);
        (_a7 = table.removeOnUpdate) == null ? void 0 : _a7.call(table, onUpdate);
      };
    },
    ...
    [
      ...
      accessorName,
      querySql,
      callbacks == null ? void 0 : callbacks.onDelete,
      callbacks == null ? void 0 : callbacks.onInsert,
