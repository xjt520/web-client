...
var _ws, __WebsocketDecompressAdapter_instances, handleOnMessage_fn, handleOnOpen_fn, handleOnError_fn, handleOnClose_fn, _a10;
var WebsocketDecompressAdapter = (_a10 = class {
  constructor(ws) {
    ...
    ws.onclose = __privateMethod(this, __WebsocketDecompressAdapter_instances, handleOnClose_fn).bind(this);
  ...
  (_a16 = this.onmessage) == null ? void 0 : _a16.call(this, { data: decompressed });
}, handleOnOpen_fn = function(msg) {
  var _a16;
  (_a16 = this.onopen) == null ? void 0 : _a16.call(this, msg);
}, handleOnError_fn = function(msg) {
  var _a16;
  (_a16 = this.onerror) == null ? void 0 : _a16.call(this, msg);
}, handleOnClose_fn = function(msg) {
  var _a16;
  (_a16 = this.onclose) == null ? void 0 : _a16.call(this, msg);
}, _a10);
...
var _queryId, _requestId, _eventId, _emitter3, _messageQueue, _outboundQueue, _subscriptionManager, _remoteModule, _reducerCallbacks, _reducerCallInfo, _procedureCallbacks, _rowDeserializers, _reducerArgsSerializers, _procedureSerializers, _sourceNameToTableDef, _getNextQueryId, _getNextRequestId, _DbConnectionImpl_instances, makeDbView_fn, makeReducers_fn, makeProcedures_fn, makeEventContext_fn, parseRowList_fn, mergeTableUpdates_fn, queryRowsToTableUpdates_fn, tableUpdateRowsToOperations_fn, querySetUpdateToTableUpdates_fn, sendEncoded_fn, flushOutboundQueue_fn, sendMessage_fn, nextEventId_fn, handleOnOpen_fn2, applyTableUpdates_fn, applyTransactionUpdates_fn, processMessage_fn, handleOnMessage_fn2, _a14;
var DbConnectionImpl = (_a14 = class {
  constructor({
    ...
    this.wsPromise = createWSFn({
      ...
      this.ws.onopen = __privateMethod(this, _DbConnectionImpl_instances, handleOnOpen_fn2).bind(this);
      this.ws.onmessage = __privateMethod(this, _DbConnectionImpl_instances, handleOnMessage_fn2).bind(this);
      return v;
    }).catch((e) => {
...
mergeTableUpdates_fn = function(updates) {
  ...
  return __privateMethod(this, _DbConnectionImpl_instances, mergeTableUpdates_fn).call(this, updates);
}, sendEncoded_fn = function(wsResolved, message) {
  stdbLogger(
    "trace",
  ...
  if (!this.isActive || __privateGet(this, _outboundQueue).length === 0) {
    return;
  }
  const pending = __privateGet(this, _outboundQueue).splice(0);
  for (const message of pending) {
    __privateMethod(this, _DbConnectionImpl_instances, sendEncoded_fn).call(this, wsResolved, message);
  }
}, sendMessage_fn = function(message) {
  this.wsPromise.then((wsResolved) => {
    if (!wsResolved || !this.isActive) {
      __privateGet(this, _outboundQueue).push(message);
      return;
    }
    __privateMethod(this, _DbConnectionImpl_instances, flushOutboundQueue_fn).call(this, wsResolved);
    __privateMethod(this, _DbConnectionImpl_instances, sendEncoded_fn).call(this, wsResolved, message);
  });
