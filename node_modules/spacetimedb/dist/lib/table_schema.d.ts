 ...
 */
export type TableSchema<Row extends Record<string, ColumnBuilder<any, any, any>>, Idx extends readonly IndexOpts<keyof Row & string>[]> = {
    /**
     ...
     */
    tableDef(ctx: ModuleContext, accName: string): RawTableDefV10 & {
...
export type UntypedTableSchema = TableSchema<Record<string, ColumnBuilder<any, any, any>>, readonly IndexOpts<string>[]>;
//# sourceMappingURL=table_schema.d.ts.map