...
export declare class UuidBuilder extends TypeBuilder<Uuid, UuidAlgebraicType> implements Indexable<Uuid, UuidAlgebraicType>, Uniqueable<Uuid, UuidAlgebraicType>, PrimaryKeyable<Uuid, UuidAlgebraicType>, Defaultable<Uuid, UuidAlgebraicType>, Nameable<Uuid, UuidAlgebraicType> {
    constructor();
    ...
    name<const Name extends string>(name: Name): UuidColumnBuilder<SetField<DefaultMetadata, 'name', Name>>;
}
/**
...
export declare class UuidColumnBuilder<M extends ColumnMetadata<Uuid> = DefaultMetadata> extends ColumnBuilder<Uuid, UuidAlgebraicType, M> implements Indexable<Uuid, UuidAlgebraicType>, Uniqueable<Uuid, UuidAlgebraicType>, PrimaryKeyable<Uuid, UuidAlgebraicType>, Defaultable<Uuid, UuidAlgebraicType>, Nameable<Uuid, UuidAlgebraicType> {
    ...
    name<const Name extends string>(name: Name): UuidColumnBuilder<SetField<M, 'name', Name>>;
}
